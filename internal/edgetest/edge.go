...
// (https://mitrity.com/docs/integrations/admission-api) and nothing more:
// token header, version header, /v1/admit, /v1/attest, /healthz. Responses
// are scripted per test; every request is recorded so a test can assert what
// the adapter sent — and, just as often, what it did not.
package edgetest
